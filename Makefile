...
MUJOCOFLAGS=$(CFLAGS) -I$(MJ_DIR)/include -L$(MJ_DIR)/bin -mavx -pthread 
...
genetic:
	$(CC) $(MUJOCOFLAGS) -I/home/drl/.mujoco/mujoco200/include $(INCLUDE) $(OPTIM_SRC) $(MLP_SRC) $(RNN_SRC) $(LSTM_SRC) $(GA_SRC) $(HOPPER_SRC) example/$@.c -o $(BIN)/$@ $(LIBS) -lmujoco200 -lGl -lglew $(MJ_DIR)/bin/libglfw.so.3
