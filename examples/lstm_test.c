...
//			one_hot[data[i]] = 1.0;
			...
			*cell->output_gate.bias = 0.1;
			...
			printf("ABOUT TO STEP:\n");
			step(&n, one_hot, expected);
			printf("FINISHED WITH STEP\n");
